...
| P4-T08 | 🔄 **IN PROGRESS** · **Implement star label mapping** — Map star rating ranges to labels: 4.5-5.0=Exceptional, 4.0-4.4=Strong, etc. per spec §4.4. (agent: claude/mark-task-in-progress-1njJ3) | P0-T06 | must-have | `src/scoring/labels.ts`, unit tests |
