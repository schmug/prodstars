...
| P0-T03 | 🔄 **IN PROGRESS** (agent: claude/mark-task-in-progress-C7vzm) · **Set up test framework** — Install and configure Vitest (or Jest). Create `tests/` directory with a smoke test. | P0-T01 | must-have | `vitest.config.ts`, passing smoke test |
